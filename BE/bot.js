...
1. Jam operasional: Setiap hari tutup kalau kiamat atau sakit
2. Produk tersedia: sembako, kopi, mie instan, es krim dan lain-lain
3. list sembako : beras, minyak goreng, telur, susu 
4. harga beras : beras cianjur Rp.13.000 1 liter, beras lele Rp.13.500 1 liter, beras garut Rp.14.000 1 liter
5. list kopi : nescafe Rp.1000, top kopi Rp. 1500, indocafe Rp. 2000, good day Rp. 2000, 
6. list mie instan : indomie goreng, indomie kuah, indomie ramen, mie sedap goreng, mie sedap kuah, mie sukses isi 2
7. list es krim : walls, campina, es serut
...
client.on('message', async msg => {
    ...
    const fullPrompt = `
Kamu adalah customer service dari Warung Abc.
